...
import guide.tour.dao.DeviceMetadataRepository;
...
public class DeviceService {
    ...
    private DeviceMetadataRepository deviceMetadataDao;
    ...
    public DeviceService(@Qualifier("deviceMetadataRepository") DeviceMetadataRepository deviceMetadataDao,
    ...
    private DeviceMetadata findExistingDevice(Long userId, String deviceDetails, String location) {
        ...
        List<DeviceMetadata> knownDevices = deviceMetadataDao.findByUserId(userId);
